...
<!-- // $order_code = $_GET['customer_phoneno']; -->
<!-- // $ret = "SELECT * FROM  rpos_customers";
// $stmt = $mysqli->prepare($ret);
// $stmt->execute();
// $res = $stmt->get_result();
// $data = $res->fetch_object();
    // $total = ($order->prod_pri ce * $order->prod_qty); -->
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                ...
                                <br> 
                                <?php  echo "+91 " . $order->customer_name; ?>   
                                <br>
                        ...
                        <address>
                                <strong>Cake Point   </strong>
                                <br>
                                Aligarh (324234)
                                
                                <br>
                                <strong>Rohan Agarwal</strong>
                                <br>
                                +91 8958888666
                                <br>
                                <strong>Arunaditya Vikram Singh</strong>
                                <br>
                                +91 6397422273

                ...
                <form method="POST">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="text" name="customer_email" value="<?php echo $cust->customer_email; ?>" class="form-control" value="">
                    </div>
                    <div class="col-md-6">
                      <label>Customer Address</label>
                      <input type="text"  name="customer_password"  class="form-control" value="<?php  echo $cust->customer_password; ?>">
                    </div>
                  </div>
                  <br>
                  <div class="form-row">
